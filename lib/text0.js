...
text.diff = function(before, after) {
  // Delegate the string diff to fast-diff (the same algorithm quill-delta uses for rich-text), then
  // map its equal/insert/delete segments to text0 ops, tracking the position along `after`.
  var op = [];
  var p = 0;
